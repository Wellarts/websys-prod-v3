...
class ProdutoPolicy
{
    ...
    {
        return $user->hasPermissionTo('View Produtos');
    }
    ...
    {
        return $user->hasPermissionTo('Create Produtos');
    }
    ...
    {
        return $user->hasPermissionTo('Edit Produtos');
    }
    ...
    {
        return $user->hasPermissionTo('Delete Produtos');
    }
